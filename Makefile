#############################################################################
# Makefile for building: ChessGameOptimize
# Generated by qmake (3.1) (Qt 5.12.2)
# Project:  ChessGameOptimize.pro
# Template: app
# Command: /home/duc13t3/Qt/5.12.2/gcc_64/bin/qmake -o Makefile ChessGameOptimize.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -I../Qt/5.12.2/gcc_64/include -I../Qt/5.12.2/gcc_64/include/QtWidgets -I../Qt/5.12.2/gcc_64/include/QtGui -I../Qt/5.12.2/gcc_64/include/QtCore -I. -isystem /usr/include/libdrm -I../Qt/5.12.2/gcc_64/mkspecs/linux-g++
QMAKE         = /home/duc13t3/Qt/5.12.2/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/duc13t3/Qt/5.12.2/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/duc13t3/Qt/5.12.2/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = ChessGameOptimize1.0.0
DISTDIR = /home/duc13t3/ChessGameOptimize/.tmp/ChessGameOptimize1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/duc13t3/Qt/5.12.2/gcc_64/lib
LIBS          = $(SUBLIBS) -L/home/duc13t3/Qt/5.12.2/gcc_64/lib -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = ../Qt/5.12.2/gcc_64/mkspecs/features/spec_pre.prf \
		...
		MoveMgr.cpp \
		BoardBuilder.cpp
QMAKE_TARGET  = ChessGameOptimize
DESTDIR       = 
TARGET        = ChessGameOptimize


first: all
####### Build rules

ChessGameOptimize:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: ChessGameOptimize.pro ../Qt/5.12.2/gcc_64/mkspecs/linux-g++/qmake.conf ../Qt/5.12.2/gcc_64/mkspecs/features/spec_pre.prf \
		../Qt/5.12.2/gcc_64/mkspecs/common/unix.conf \
		../Qt/5.12.2/gcc_64/mkspecs/common/linux.conf \
		../Qt/5.12.2/gcc_64/mkspecs/common/sanitize.conf \
		../Qt/5.12.2/gcc_64/mkspecs/common/gcc-base.conf \
...
all: Makefile ChessGameOptimize
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Piece.h Tile.h BoardUntils.h Bishop.h Board.h Move.h MoveMgr.h Move.h BoardBuilder.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp Piece.cpp Tile.cpp Bishop.cpp Board.cpp Move.cpp MoveMgr.cpp BoardBuilder.cpp $(DISTDIR)/
...
moc_predefs.h: ../Qt/5.12.2/gcc_64/mkspecs/features/data/dummy.cpp
	g++ -pipe -g -Wall -W -dM -E -o moc_predefs.h ../Qt/5.12.2/gcc_64/mkspecs/features/data/dummy.cpp
...
main.o: main.cpp ../Qt/5.12.2/gcc_64/include/QtCore/QCoreApplication \
...
MoveMgr.o: MoveMgr.cpp MoveMgr.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MoveMgr.o MoveMgr.cpp

BoardBuilder.o: BoardBuilder.cpp BoardBuilder.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o BoardBuilder.o BoardBuilder.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/ChessGameOptimize/bin || mkdir -p $(INSTALL_ROOT)/opt/ChessGameOptimize/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/ChessGameOptimize/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/ChessGameOptimize/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/ChessGameOptimize/bin/ 
